...
이 방법을 사용하면 [큰 수의 법칙](https://ko.wikipedia.org/wiki/%ED%81%B0_%EC%88%98%EC%9D%98_%EB%B2%95%EC%B9%99)에 따라 여러 프로세스가 경쟁하면서 실행되는 전체 시간이 길어질수록 각 프로세스가 원하던 비율로 실행될 가능성이 높다.
